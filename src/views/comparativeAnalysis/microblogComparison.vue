...
import { selectManagementAnalysis, selectAccountAnalysis } from '@/api/comparativeAnalysis'
export default {
  ...
  data() {
    return {
      ...
      layout: [
        ...
        {
          'x': 0, 'y': 0, 'w': 6, 'h': 4, 'i': '2', chart: 'hotModelMore',
          data: [
            [
              { name: '参与', value: 30 },
              { name: '教育', value: 28 },
  ...
  mounted() {
    ...
    // this.getselectManagementDataList()
  },
  methods: {
